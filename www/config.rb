...
redirect 'tutorials/getting-started-basic-concepts.html', to: 'tutorials/getting-started/basic-concepts.html'
...
redirect 'tutorials/getting-started-review-create-plan.html', to: 'tutorials/getting-started/mac/create-plan.html'
